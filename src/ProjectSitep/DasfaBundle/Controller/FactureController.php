...
use ProjectSitep\DasfaBundle\Entity\Facture;
...
class FactureController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $factures = $em->getRepository('ProjectSitepDasfaBundle:Facture')->findAll();
    ...
    {
        $facture = new Facture();
        $form = $this->createForm('ProjectSitep\DasfaBundle\Form\FactureType', $facture);
    ...
    {
        $deleteForm = $this->createDeleteForm($facture);
        $editForm = $this->createForm('ProjectSitep\DasfaBundle\Form\FactureType', $facture);
