...
use ProjectSitep\DfinBundle\Entity\Cheque;
...
class ChequeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cheques = $em->getRepository('ProjectSitepDfinBundle:Cheque')->findAll();
    ...
    {
        $cheque = new Cheque();
        $form = $this->createForm('ProjectSitep\DfinBundle\Form\ChequeType', $cheque);
    ...
    {
        $deleteForm = $this->createDeleteForm($cheque);
        $editForm = $this->createForm('ProjectSitep\DfinBundle\Form\ChequeType', $cheque);
